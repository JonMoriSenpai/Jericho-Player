const config = {
    TITLE: "Jericho Player", // this will dynamically update the title
    SITE_NAME: "Jericho Player",
    THEME: "light", // "light" | "dark"
    NAV: {
        ICON: {
            TYPE: "TEXT", // "TEXT" | "IMAGE"
            VALUE: "Jericho Player", // IMAGE path or TEXT
            HREF: "/" // href
        },
        BUTTONS: [
            {
            ...
            {
                label: "Discord",
                path: "https://discord.gg/MfME24sJ2a",
                newPage: true
            },
            {
                label: "GitHub",
                path: "https://github.com/SidisLiveYT/Jericho-Player",
                newPage: true
            }
        ]
    },
    INSTALL_COMMAND: "npm i jericho-player",
    HOME_LOGO: {
        TYPE: "TEXT", // "IMAGE" | "TEXT"
        VALUE: "Jericho Player"
    },
    DESCRIPTION: {
        TITLE: "About",
        VALUE: "🎧 Complete framework to simplify the implementation of music commands using discord.js v13"
    },
    DESCRIPTION_LIST: {
        ...
        VALUE: [
            ...
            "Audio Proxy 🎸",
            "Lightweight 🛬",
            "youtube-dl and play-dl extractors support 🌌",
            "Multiple sources support ✌",
            "Play in multiple servers at the same time 🚗"
        ]
    },
    FOOTER: {
        HEADER: "Jericho Player",
        DESCRIPTION: "Jericho Player Package docs"
    },
    LINKS: {
